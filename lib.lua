...
library.Theme = {
    ...
    BackgroundAlt = library.Theme.BackgroundAlt,
    Accent = library.Theme.Accent,
    AccentDark = library.Theme.AccentDark,
    Text = library.Theme.Text,
    TextDim = library.Theme.TextDim,
    TextDark = library.Theme.TextDark,
    TextPlaceholder = library.Theme.TextPlaceholder,
    Secondary = library.Theme.Secondary,
    Edge = library.Theme.Edge
}
